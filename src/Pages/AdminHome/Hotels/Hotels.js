...
export default function Hotels() {
    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-8 px-10 mt-10'>
            ...
            {!hotels
                ...
                : hotels.map((hotel) => (
                      <div
                          className='grid grid-cols-8 px-10 mt-1'
                          key={uuidv4()}
                      >
                          <div className=' flex justify-center py-4'>
            ...
            <Link
                to='./create'
                className='block py-2 w-1/3 flex justify-center t-josefin uppercase t-josefin bg-gold text-white ml-20 mt-10 mb-8 hover:bg-white hover:text-black hover:border hover:border-black '
            >
